...
from src.core.models.schemas import TranscriptSegment, TranscriptWord
...
class MLEngine:
    ...
    FILLER_WORDS = {
        "ну", "короче", "типа", "как", "бы", "э", "ээ", "эээ", "мм", "ммм",
        "вот", "значит", "собственно", "вообще", "походу"
    }
    ...
    def analyze_audio_features(audio_path: str) -> Dict[str, float]:
        try:
            ...
            return {"volume_std": float(volume_std), "volume_score": float(volume_score)}
