...
@router.post(
    ...
    description=(
        ...
        "файл критериев оценки (либо ID пресета из базы), а также "
        "необязательный файл презентации. Запускает асинхронный пайплайн "
        ...
        400: {
            ...
            "content": {
                "application/json": {
                    "example": {
                        "detail": (
                            "Необходимо загрузить либо видео "
                            "выступления, либо ссылку на него"
                        )
                    }
                }
            },
