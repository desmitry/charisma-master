	...
	return (
		<div
			className={cn(
				...
				accent === "red"
					? "border-rose-500/20 bg-black/40 backdrop-blur-2xl hover:border-rose-500/40"
					: accent === "amber"
						? "border-amber-500/20 bg-black/40 backdrop-blur-2xl hover:border-amber-500/40"
				...
				{accent && (
					<div
						className={cn(
							...
							accent === "red" &&
								"bg-rose-500/50 shadow-[0_0_10px_rgba(244,63,94,0.5)]",
							accent === "amber" &&
