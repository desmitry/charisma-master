	...
	return (
		...
		>
			<svg
				...
				viewBox="0 0 14 14"
				fill="none"
				className="cursor-pointer text-white/30 hover:text-white/60 transition-colors flex-shrink-0"
			>
	...
	return (
		<div className="rounded-[24px] bg-[#111] border border-white/[0.06] text-white flex flex-col w-full sm:min-w-[300px] lg:max-w-[340px] mx-auto lg:mx-0">
			<div className="px-6 pt-5 pb-0">
				<p className="text-[11px] font-mono text-white/35 uppercase tracking-[0.18em]">
					Общая статистика
				</p>
			</div>
				...
				{needVideoAnalysis && (
					<div className="flex flex-col">
						...
						<div className="flex items-baseline gap-2 mt-1">
							<span className="text-[24px] font-bold tracking-tight leading-none text-white">
								{score}
							</span>
