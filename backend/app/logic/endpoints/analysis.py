...
@router.get(
    ...
    description=(
        "Возвращает полный отчёт по анализу выступления после завершения обработки.\n\n"
        "**Включает:**\n"
        "- Транскрипцию речи с временными метками\n"
        "- Темп речи (слов/мин) по временной шкале\n"
        "- Длинные паузы (> 2 сек)\n"
        "- Индекс уверенности оратора (0-100)\n"
        "- LLM-отчёт: резюме, ошибки, улучшенный текст\n"
