  ...
  constructor(maxWaves: number = 4) {
    ...
    super({
      ...
      void main() { 
        ...
        // Calculate distance to mouse for color/size effects
        vDistToMouse = length(pos.xz - uMousePosition);
        
        // Increase point size near cursor
      ...
      void main() {
        ...
        // Base color - subtle warm gradient based on Y position
        float yGradient = smoothstep(-0.8, 0.5, vPosY);
        
        // Cool blue base color
        ...
        // Accent color near mouse - subtle cyan/teal glow
        ...
        // Click pulse effect - golden flash
        ...
        // Soft edge falloff for more polished look
