        ...
        <>
            ...
            <section className="snap-section relative z-10 w-full text-white lg:min-h-svh">
                <div className="flex flex-col items-center justify-center px-4 py-16 sm:px-6 lg:min-h-svh">
                    <div
                        className="w-full max-w-3xl rounded-3xl border border-white/10 bg-white/5 px-6 py-8 text-center backdrop-blur-md sm:px-8 sm:py-12">
            ...
            <section className="snap-section relative z-10 w-full text-white lg:min-h-svh">
                <div className="flex flex-col items-center justify-center px-4 py-16 sm:px-6 lg:min-h-svh">
                    <div
                        className="w-full max-w-4xl rounded-[32px] border border-white/10 bg-black/35 px-6 py-12 shadow-[0_40px_120px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:px-8 sm:py-14">
                        ...
                        <p className="mt-4 text-center text-sm text-white/70 sm:text-base">
                            Перетащи или выбери видео которое ты хочешь проанализировать. Можешь попробовать вставить
                            ссылку как альтернативный вариант.
                        </p>
                        ...
                        <div className="mt-10 grid gap-6 md:grid-cols-2">
                            ...
                            <div className="rounded-3xl border border-white/15 bg-white/5 px-6 py-8">
                                ...
                                />
                                <button
                                    className="mt-4 w-full rounded-2xl bg-white/20 py-3 text-sm font-semibold text-white transition hover:bg-white/35">
                                    Анализируй
                                </button>
